...
void main() async {
  ...
  runApp(NotificationScreenn());
}

class NotificationScreenn extends StatefulWidget {
  static const routeName = '/NotificationScreenn';
  @override
  NotificationScreennState createState() => NotificationScreennState();
}

class NotificationScreennState extends State<NotificationScreenn> {
  late String token;
  List subscribed = [];
  List topics = [
    'Samsung',
